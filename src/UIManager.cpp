...
void UIManager::update(float dt){
	...
	m_scoreDisplay.setString(std::string(UI_SCORE_PREFIX) + std::to_string(m_score));
	...
	m_scoreDisplay.setPosition(UI_X, top + UI_Y);
	m_timerDisplay.setPosition(sf::Vector2f(UI_X, top + (UI_Y * 2.f)));
